...
Dumang DK6 is a modular keyboard compatible with Cherry-MX switch (not with low profile). To see what the keyboard look like, see photos and my experience at [[xah-dumang][Xahlee's Dumang DK6 keyboard page]]. If you know Chinese, you can visit the official product page [[dumang][here]] for a lot more information.
