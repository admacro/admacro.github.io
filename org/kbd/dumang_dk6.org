...
*** Solution
Install and setup [[https://pypi.org/project/dumang-ctrl/][Dumang-ctrl]] ([[dumang-ctrl-repo][github repo]]). Dumang-ctrl is a runnable script written in Python 3. It syncs the events between two Dumang DK6 keyboards. For example, when you press =Fn= on one board to switch to layer 1, the other board will also be switched to layer 1.
